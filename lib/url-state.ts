...
/**
 * v2 (2026-09-24) — STAGE 1 d1c(자연·유료 유입 비율)를 d1e(플랫폼 수수료 vs 자사몰 광고비)로 교체.
 * 자리(세 번째)는 같고 id만 다르다. v1 링크는 v1 순서로 읽혀 d1c 키를 돌려주며, 스코어링은
 * 현재 DEEP_QUESTIONS에 없는 d1c를 읽지 않으므로 STAGE 1이 d1a·d1b·d1d 평균으로 계산된다.
 */
export const FULL_ORDER_V2: readonly string[] = Object.freeze([
  "d1a", "d1b", "d1e", "d1d",
  "d2a", "d2b", "d2c", "d2d",
  "d3a", "d3b", "d3c", "d3d", "d3e",
  "d4a", "d4b", "d4c", "d4d", "d4e",
...
/**
 * v3 (2026-09-24) — STAGE 5 d5b(재고 소진 예측·사전 발주)를 d5e(품절·미송 취소 건수 확인)로 교체.
 * 자리(스무 번째)는 같고 id만 다르다. v1·v2 링크의 d5b 답은 채점에서 빠져 STAGE 5가
 * d5a·d5c·d5d 평균으로 계산된다.
 */
export const FULL_ORDER_V3: readonly string[] = Object.freeze([
  "d1a", "d1b", "d1e", "d1d",
  "d2a", "d2b", "d2c", "d2d",
  "d3a", "d3b", "d3c", "d3d", "d3e",
  "d4a", "d4b", "d4c", "d4d", "d4e",
